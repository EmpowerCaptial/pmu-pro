...
export default function FundamentalsTrainingPortal() {
  ...
  const [selectedStudentForWeeks, setSelectedStudentForWeeks] = useState<{ userId: string; userName: string; userEmail: string } | null>(null)
  const [studentWeeksDialogOpen, setStudentWeeksDialogOpen] = useState(false)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-purple-50 to-violet-100">
      ...
      {/* Progress Portfolio View Dialog */}
      <Dialog open={portfolioViewDialogOpen} onOpenChange={setPortfolioViewDialogOpen}>
                        ...
                        <div className="space-y-3">
                          <div className="space-y-2">
                            <div className="flex items-center justify-between text-sm">
                              <span className="text-gray-600 font-medium">Best Work Photo</span>
                              <div className="flex gap-2">
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between text-sm">
                              <span className="text-gray-600 font-medium">Reflection Notes</span>
                              <Button
                                size="sm"
                                variant="outline"
                                className="text-xs"
                            ...
                            {portfolioItem.reflectionNotes && (
                              <div className="mt-2 p-3 bg-purple-50 rounded text-xs text-purple-700 max-h-24 overflow-y-auto whitespace-pre-wrap">
                                {portfolioItem.reflectionNotes}
                              </div>
                            )}
                          </div>
