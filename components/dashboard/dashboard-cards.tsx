    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="lg:hidden mb-4 sm:mb-6">
        ...
        <div className="lg:hidden grid grid-cols-1 gap-2 sm:gap-3 mb-4 sm:mb-6">
          ...
          {/* Stripe Connect Card - Only for owners, licensed artists, and instructors who receive payments */}
          {/* Students don't receive direct client payments - they are paid by owner separately */}
